var rootnodeTorrentManager = {
            ...
            onAttach: function(worker) {
                ...
                worker.port.on('registerUser', function(data) {
                    ...
                    _this.sendAPIRequest({
                        ...
                        error: function(response) {
                            worker.port.emit('userRegistered', (response.response ? response.response : response));
                        }
                    });
                });
    ...
    getTorrentsOnPage: function getTorrentsOnPage(query, page, callback) {
        ...
        this.addOnSdk.url.readURI('https://torrentz.ch/search?f=' + query + page).then(function (resp) {
